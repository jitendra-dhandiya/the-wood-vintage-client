...
export default function EditProductPage() {
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...
      manufacturingTimeDays: product?.manufacturingTimeDays ?? '',
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        // an absent key leaves the existing value untouched on update.
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} lg={8}>
              ...
              {/* Craft & Dimensions — Phase 2 handicraft domain. materialId/
                  ...
                  Fabric/Material field above (that maps to the legacy
                  fashion `fabric` column and is unrelated taxonomy). */}
              <Card elevation={0} sx={{ border: '1px solid', borderColor: 'divider', borderRadius: 2, mb: 3 }}>
                <CardContent sx={{ p: 3 }}>
